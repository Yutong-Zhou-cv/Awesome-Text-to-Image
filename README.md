...
* <span id="head-2023"> **2023**  </span> **[       «🎯Back To Top»       ](#)**
     ...
     * ⭐⭐(bioRXiv preprint 2023) [💬Stable Diffusion with Brain]**High-resolution image reconstruction with latent diffusion models from human brain activity**, Yu Takagi et al. [[Paper](https://www.biorxiv.org/content/10.1101/2022.11.18.517004v1)] [[Project](https://sites.google.com/view/stablediffusion-with-brain/)] 
     * ⭐⭐(arXiv preprint 2023) **Adding Conditional Control to Text-to-Image Diffusion Models**, Lvmin Zhang et al. [[Paper](https://arxiv.org/abs/2302.05543)] [[Code](https://github.com/lllyasviel/ControlNet)] 
